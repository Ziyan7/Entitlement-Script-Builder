...
-- <PROD_SCHEMA_NAME>asdfdvd</PROD_SCHEMA_NAME>
...
-- <JIRA>https://jira-aes.kp.org/browse/setViewPullRequest(false);</JIRA>
-- <SHORTID>208</SHORTID>
/*********************************************************************************************************/
...
INSERT INTO WPP_CFE_PRVLG_FOR_RGN ( CFE_ID, RGN_ID, DIS_IN ) VALUES ( (select cfe_id from wpp_cfe where CFE_NM=CareMgmt-CondMgmt-Immunizations), 'GGA', 'Y');
