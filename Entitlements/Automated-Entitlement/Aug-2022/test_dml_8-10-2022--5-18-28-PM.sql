...
-- <JIRA>https://jira-aes.kp.org/browse/RM-41238</JIRA>
-- <SHORTID>232</SHORTID>
/*********************************************************************************************************/

delete from WPP_CFE_PRVLG_FOR_RGN where CFE_ID=(select cfe_id from wpp_cfe where CFE_NM='Questionnaires') and RGN_ID in ('SCA','GGA','MRN');
...
INSERT INTO WPP_CFE_PRVLG_FOR_RGN ( CFE_ID, RGN_ID, DIS_IN ) VALUES ( (select cfe_id from wpp_cfe where CFE_NM=Questionnaires), 'MRN', 'N');
