...
-- <PROD_SCHEMA_NAME>WFQ</PROD_SCHEMA_NAME>
...
INSERT INTO WPP_ENTL_PRMSN_OVRD (WPP_ENTL_PRMSN_OVRD_IK,RGN,GUID,ENTL_PRMSN,ENTL_NM,ENTL_SRC_ID,PILOT_APP_NAME,CRTE_DT_TM,MOD_DT_TM)VALUES (null,'Southern California (SCA)','123','PERMIT','CareMgmt-ClinDxHealthCond','EPIC','CareMgmt-ClinDxHealthCond',SYSTIMESTAMP,SYSTIMESTAMP);
